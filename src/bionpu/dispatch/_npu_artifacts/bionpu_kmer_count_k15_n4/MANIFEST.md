# bionpu_kmer_count_k15_n4

K-mer count NPU artifact for k=15, n_tiles=4.
...
|----------------|---------------:|-----------------------------------------------------------------|
| final.xclbin   | 43241   | b3ad1a1091e82b8fb180e71dd4d44fcb919e3391de100e6073b59b297dd36d65 |
| insts.bin      | 300    | cee7b74fcb09d544049afadef8479a16aba5ace59fdae9b95007ff680ac85ca7  |
...
- Build invocation:
      ...
      make NPU2=1 K=15 experiment=wide4 seq=10000 all
      cp build/final_k15_n4_L10000.xclbin <here>/final.xclbin
      cp build/insts_k15_n4_L10000.bin    <here>/insts.bin

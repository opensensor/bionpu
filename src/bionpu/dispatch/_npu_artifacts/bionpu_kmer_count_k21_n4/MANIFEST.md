# bionpu_kmer_count_k21_n4

K-mer count NPU artifact for k=21, n_tiles=4.
...
|----------------|---------------:|-----------------------------------------------------------------|
| final.xclbin   | 43417   | 06f31ae934826fcedd3134840b8b4d4e1323bd8e7e086218815f9f09a7c912b9 |
...
- Build invocation:
      ...
      make NPU2=1 K=21 experiment=wide4 seq=10000 all
      cp build/final_k21_n4_L10000.xclbin <here>/final.xclbin
      cp build/insts_k21_n4_L10000.bin    <here>/insts.bin

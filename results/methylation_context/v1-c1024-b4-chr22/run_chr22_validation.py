...
artifact = ROOT / 'src/bionpu/dispatch/_npu_artifacts/bionpu_methylation_context_n4_b4_c1024'
out_path = Path(__file__).resolve().parent / 'silicon_chr22_c1024_b4.bin'

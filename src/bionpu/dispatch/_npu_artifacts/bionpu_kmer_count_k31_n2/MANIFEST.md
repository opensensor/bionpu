# bionpu_kmer_count_k31_n2

K-mer count NPU artifact for k=31, n_tiles=2.
...
|----------------|---------------:|-----------------------------------------------------------------|
| final.xclbin   | 25465   | a1643243c5209fdfd6299277380d8dc4a069f156ac5c7dbc09434a17cec47b0a |
...
- Build invocation:
      ...
      make NPU2=1 K=31 experiment=wide2 seq=10000 all
      cp build/final_k31_n2_L10000.xclbin <here>/final.xclbin
      cp build/insts_k31_n2_L10000.bin    <here>/insts.bin

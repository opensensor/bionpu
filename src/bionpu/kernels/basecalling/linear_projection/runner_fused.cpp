...
// runner_fused.cpp — host runner for the DESIGN-fusion stage 3 fused
// linear projection. Wire format: bf16 input (L * 96), bf16 weight
// (24576; full slab), bf16 output (L * 256). The Python __init__.py
// converts fp32 -> bf16 on the way in and bf16 -> fp32 on the way
// back, mirroring the lstm_cell_bf16/lstm_cell_bf16_acc convention.

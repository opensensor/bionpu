# bionpu_kmer_count_k31_n1

K-mer count NPU artifact for k=31, n_tiles=1.
...
|----------------|---------------:|-----------------------------------------------------------------|
| final.xclbin   | 16041   | 373d6f2204a9bea1fbb02b8d18bc756c45f03aa5ac344b33e07636931f07a2da |
...
- Build invocation:
      ...
      make NPU2=1 K=31 experiment=production seq=10000 all
      cp build/final_k31_n1_L10000.xclbin <here>/final.xclbin
      cp build/insts_k31_n1_L10000.bin    <here>/insts.bin
